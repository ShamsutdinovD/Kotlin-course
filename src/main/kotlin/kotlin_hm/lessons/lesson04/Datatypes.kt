package kotlin_hm.kotlin_hm.lessons.lesson04
...
// значение булева пишется строчными буквами
...
// Char это одиночный символ, тут не так, и кавычка не та. Или убрать кавычки и будет double
// val v20 = `1.414`
...
// не те кавычки, или убрать кавычки
// val v34:  = ‘65535’
...
val q3: Array<Double> = arrayOf(1032.50, 2011.0)
//4. Хранить длину очереди в столовой до миллиардной доли сантиметра.
val q4: Double = 101.010111313
